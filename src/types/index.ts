...
export interface OarInstance extends AxiosStatic {
  ...
  // 继承 AxiosStatic 的 create 方法，返回一个新的 OarInstance 对象
  create(config?: OarRequestConfig): OarInstance;
}
...
export type OarPromise<T = any> = Promise<OarResponse<T>>;

// interface CacheManager {
//   get(request : OarRequestConfig): CachedApiBody,
//   set(response : OarResponse): void,
//   clearExpired(): void,
//   clearAll(): void
// }

// interface CachedApiBody {
//   expireTime: number,
//   response: OarResponse
// }

// interface CachedApisDictionary {
//   [fullRequestUrl : string]: CachedApiBody
// }
